...
// Fonts
			...
			$typography_mixed_fonts["Roboto"] = "Roboto *";
...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '21px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#999999'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '36px', 'lineheight' => '35px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#999999'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '36px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#999999'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '32px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#1a1a1a'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '29px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#999999'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '26px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#999999'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '24px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#999999'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '30px', 'lineheight' => '32px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#303030'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#303030'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '16px', 'lineheight' => '19px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#1a1a1a'));
