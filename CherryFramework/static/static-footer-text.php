...
<div id="footer-text" class="footer-text">
	...
	<?php if( is_front_page() ) { ?>
		More <a rel="nofollow" href="http://www.templatemonster.com/category/architecture-wordpress-templates/" target="_blank">Architecture WordPress Templates at TemplateMonster.com</a>
	<?php } ?>
</div>